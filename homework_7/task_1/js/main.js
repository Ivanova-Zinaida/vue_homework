Vue.component('home', { template: `<div> <h1 class='title'>This is Homе</h1>
...
Vue.component('shop', { template: `<div>
...
Vue.component('blog', { template: `<div>
...
Vue.component('portfolio', { template: `<div>
